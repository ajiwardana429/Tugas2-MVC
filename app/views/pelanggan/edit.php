...
<div class="container">
   ...
   <input type="hidden" name="pel_no"value="<?php echo $data['row']['pel_no']; ?>">
        <input type="hidden" name="pel_id"value="<?php echo $data['row']['pel_id']; ?>">
      <div class="form-row">
         <div class="input-data">
            <input type="text" name="pel_nama" value="<?php echo $data['row']['pel_nama']; ?>" required>
            <div class="underline"></div>
            <label for="">Nama Pelanggan</label>
         </div>
         <div class="input-data">
            <input type="text" name="pel_alamat"value="<?php echo $data['row']['pel_alamat']; ?>"required>
            <div class="underline"></div>
      ...
      <div class="form-row">
        <div class="input-data">
            <input type="text" name="pel_seri"value="<?php echo $data['row']['pel_seri']; ?>"required>
            <div class="underline"></div>
